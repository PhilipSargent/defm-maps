...
The documentation is currently being typed by Jane, but it
will need completing after that.
...
before you run DFM290 (see section 7.4, page 49). This only works
with copies of Olivetti's graphics.com dated 28 July 1986 or later.
...
will STILL be present in a MATL????.TMP file.  It is very safe.
